...
const DOCK_APPS = [
  { id: 'questlearn' as const, icon: '🎓', label: 'QuestLearn', color: '#f59e0b', available: true },
  { id: 'teacher' as const, icon: '📊', label: 'Teacher Hub', color: '#60a5fa', available: true },
  { id: 'showcase' as const, icon: '🎬', label: 'Showcase', color: '#a78bfa', available: true },
  { id: 'student-dashboard' as const, icon: '🏠', label: 'My Dashboard', color: '#34d399', available: true },
  { id: 'mini-apps' as const, icon: '🧩', label: 'Mini Apps', color: '#ec4899', available: false },
  { id: 'pitch' as const, icon: '📋', label: 'Pitch Deck', color: '#f59e0b', available: true },
  { id: 'student-help' as const, icon: '🎒', label: 'Student Guide', color: '#34d399', available: true },
  { id: 'teacher-help' as const, icon: '📖', label: 'Teacher Guide', color: '#60a5fa', available: true },
]
        ...
        return (
          <div key={app.id} className="flex flex-col items-center gap-1">
            <button
              ...
              className="dock-icon flex items-center justify-center rounded-[14px] text-2xl transition-transform duration-200 ease-out"
              style={{
                width: '60px',
                height: '60px',
              ...
              title={app.available ? app.label : `${app.label} (Coming Soon)`}
            >
              {app.icon}
            </button>
            {!app.available && (
